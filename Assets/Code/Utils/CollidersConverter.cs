...
{
    public static class CollidersConverter 
    {
        public static IEnumerable<Collider> GetAlLColliders(this GameObject go)
        {
        ...
        public static void ToWorldSpaceBox(this BoxCollider box, out float3 center, 
            out float3 halfExtents, out quaternion quaternion)
        {
